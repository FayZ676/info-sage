...
export default function ChatPage({ chatId, title, messages = [] }) {
  ...
  // Reset newChatMessages and newChatId when a new chat is loaded
  useEffect(() => {
    setNewChatMessages([]);
    setNewChatId(null);
  }, [chatId]);

  // Redirect to the new chat page when the response is finished generating is false and the id for the chat is available
  useEffect(() => {
